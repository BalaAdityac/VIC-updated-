...
r.get("/student/applications",auth,requireRole("STUDENT"),applications.studentList);
...
r.patch("/company/interviews/:interviewId/reschedule",auth,requireRole("COMPANY"),validate(v.interviewSchema),interviews.reschedule);
