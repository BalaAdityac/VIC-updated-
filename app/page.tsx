...
export default function StudentDashboard() {
  ...
  const [profile, setProfile] = useState({
    ...
    bio: "Passionate engineer focusing on embedded architectures, real-time telemetry, and modern Next.js systems.",
    linkedinUrl: "https://linkedin.com/in/bala-aditya",
    githubUrl: "https://github.com/aditya",
    portfolioUrl: "https://aditya.dev",
    skills: "React, Next.js, Node.js, TypeScript, PostgreSQL, FreeRTOS, C++"
  });
...
// Submit Application with Duplicate Check & Realtime Cross-Tab Pipeline Sync
  const handleApplySubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 2. Send payload to Backend Fastify API (if token exists)
      ...
      const newApp = {
        ...
        name: profile.name,
        email: profile.email,
        company: selectedJob.company || "Tenar Systems",
      ...
      // 4. Save to shared applications storage (accessible by Company dashboard)
      ...
      // 5. Dispatch real-time events for active tab listeners & other open browser windows
  ...
  // Extract Student Initials for Avatar
    ...
    <div className="min-h-screen bg-[#F8F9FD] text-slate-800 flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 sm:p-8 space-y-8 max-w-7xl">
              ...
              <section className="bg-gradient-to-br from-[#EDF0FF] via-white to-[#F8F9FD] border border-[#3B3588]/10 p-6 sm:p-8 rounded-3xl shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 max-w-xl">
                    Track applications, join scheduled technical interview rounds, and build your student portfolio.
                  </p>
                </div>
                <button
                  onClick={() => setActiveTab("internships")}
          ...
          {/* 2. MY PROFILE TAB (NEW DELIVERABLE) */}
          {activeTab === "profile" && (
