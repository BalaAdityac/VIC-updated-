        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="glass relative overflow-hidden rounded-[3rem] p-8 animate-fade-up">
            ...
            <div className="relative rounded-[2.5rem] bg-gradient-to-br from-[#DDF8FF] to-[#EDE8FF] p-10 min-h-[420px] flex flex-col justify-center">
              ...
              {/* Main Words */}
              <div className="mt-6 text-5xl sm:text-6xl font-black leading-none tracking-tight text-[#15324B]">
                Learn.
              </div>

              <div className="text-5xl sm:text-6xl font-black leading-none text-[#1677FF]">
                Grow.
              </div>

              <div className="text-5xl sm:text-6xl font-black leading-none text-[#20C8E8]">
                Lead.
              </div>
            </div>
          </div>
