        ...
        <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-[#1677FF] via-[#18BFE7] to-[#7564F5] p-10 text-center text-white md:p-20">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <Link href="#contact" className="rounded-full border border-white/40 bg-white/10 px-8 py-4 font-black backdrop-blur transition hover:bg-white/20">Contact Us</Link>
            </div>
          </div>
        </div>
      </div>
