...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#D9DFFF] text-[#1E1B4B] pt-12 pb-8 px-6 mt-20">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center pb-8 border-b border-[#2E2A72]/10">
