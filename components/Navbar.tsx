    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 py-4 bg-[#F8F9FD]/90 backdrop-blur-md border-b border-[#3B3588]/10">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          <Link
            href="/signin"
            className="px-4 py-2.5 text-[#2E2A72] text-sm font-bold rounded-full hover:bg-[#E5E9FF] transition-all"
          >
            Sign In
          </Link>
          ...
          <Link
            href="/signup"
            className="px-5 py-2.5 bg-[#2E2A72] hover:bg-[#3B3588] text-white text-sm font-bold rounded-full shadow-lg shadow-[#2E2A72]/20 hover:scale-105 active:scale-95 transition-all"
          >
            Sign Up
          </Link>
        </div>
